...
<img src="media/readme/supply_import.png" alt="Поставка и импорт (макет)" width="720" />
...
### 3.2 Карточка товара
 ...
 - Наличие по локациям, итог, локальное имя, фото.
...
<img src="media/readme/inventory.png" alt="Инвентаризация (макет)" width="720" />
